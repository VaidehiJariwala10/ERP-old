                                        ...
                                        <div class="table-top">
                                            <div class="search-set">
                                                ...
                                                <div class="search-input">
                                                    <a class="btn btn-searchset"><img src="admin/assets/img/icons/search-white.svg" alt="img"></a>
                                                </div>
                                            </div>
                                            <div class="wordset">
                                                <ul>
                                                    <li>
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="pdf"><img src="admin/assets/img/icons/pdf.svg" alt="img"></a>
                                                    </li>
                                                    <li>
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="excel"><img src="admin/assets/img/icons/excel.svg" alt="img"></a>
                                                    </li>
                                                    <li>
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="print"><img src="admin/assets/img/icons/printer.svg" alt="img"></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body pb-0">
                                                <div class="row">
                                                    <div class="col-lg-2 col-sm-6 col-12">
                                                        <div class="form-group">
                                                            <div class="input-groupicon">
                                                                ...
                                                                <div class="addonset">
                                                                    <img src="admin/assets/img/icons/calendars.svg" alt="img">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-1 col-sm-6 col-12 ms-auto">
                                                        <div class="form-group">
                                                            <a class="btn btn-filters ms-auto"><img src="admin/assets/img/icons/search-whites.svg" alt="img"></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="productimgname">
                                                            <a class="product-img">
                                                                <img src="admin/assets/img/product/product1.jpg" alt="product">
                                                            </a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="productimgname">
                                                            <a class="product-img">
                                                                <img src="admin/assets/img/product/product7.jpg" alt="product">
                                                            </a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="productimgname">
                                                            <a class="product-img">
                                                                <img src="admin/assets/img/product/product8.jpg" alt="product">
                                                            </a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="productimgname">
                                                            <a class="product-img">
                                                                <img src="admin/assets/img/product/product9.jpg" alt="product">
                                                            </a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="productimgname">
                                                            <a class="product-img">
                                                                <img src="admin/assets/img/product/product10.jpg" alt="product">
                                                            </a>
