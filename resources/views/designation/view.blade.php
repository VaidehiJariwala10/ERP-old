...
@section('content')
    <style>
        ...
        @media (min-width: 1200px) {
            .col-details,
            table#designationTable thead th.details-column,
            table#designationTable tbody td.col-details {
                display: none !important;
            }
        }

        /* Mobile: hide hash, department, action; show details toggle and main */
        @media (max-width: 1199px) {
            .col-hash,
            .col-dept,
            .col-action,
            table#designationTable thead th.col-hash,
            table#designationTable thead th.col-dept,
            table#designationTable thead th.col-action,
            table#designationTable tbody td.col-hash,
            table#designationTable tbody td.col-dept,
            table#designationTable tbody td.col-action {
                display: none !important;
            }

            .col-details,
            .col-main,
            table#designationTable thead th.col-details,
            table#designationTable thead th.col-main,
            table#designationTable tbody td.col-details,
            table#designationTable tbody td.col-main {
            ...
            <div class="card-body">
                    ...
                    <table class="table" id="designationTable">
                        <thead>
                            <tr>
                                ...
                                <th class="col-main">Designation</th>
                ...
                <div class="pagination-controls d-flex flex-column flex-md-row justify-content-between align-items-center mt-3">
                    <div class="d-flex align-items-center mb-3 mb-md-0">
                        ...
                        <select id="designationPerPage" class="form-select form-select-sm"
            ...
            function loadDesignations() {
                $.ajax({
                    ...
                    const rows = designations.map((designation, index) => {
                        const actions = `
                                <a class="me-3 openDesignationEdit" data-id="${designation.id}" href="javascript:void(0);">
                                    <img src="{{ env('ImagePath') . 'admin/assets/img/icons/edit.svg' }}" alt="Edit">
                                </a>
                                <a class="me-3 confirm-text deleteDesignation" data-id="${designation.id}" href="javascript:void(0);">
                                    <img src="{{ env('ImagePath') . 'admin/assets/img/icons/delete.svg' }}" alt="Delete">
                                </a>
                        `;
                        const desigName = designation.designation_name ?? '-';
                        const deptName = designation.department_name ?? '-';
                        ...
                        <tr>
                            ...
                            <td class="col-main">
                                <div style="display: flex;">
                                    <span style="color: #1b2850; font-weight: 500;">${desigName}</span>
                                </div>
                                <div class="collapse mt-2 d-xl-none" id="details-${designation.id}">
                                    <div>
                            ...
                            <td class="col-dept">${deptName}</td>
                            <td class="col-details">
                                <a href="#details-${designation.id}" class="toggle-details" data-bs-toggle="collapse">
                    ...
                    $('#designationTable tbody').html(rows || '<tr><td colspan="5" class="text-center">No records found</td></tr>');
                    updatePaginationUI();
                }).fail(handleError);
            }
