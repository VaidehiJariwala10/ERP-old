...
<style>
    ...
    @media (min-width: 1200px) {
        .col-details,
        table#holidayTable thead th.details-column,
        table#holidayTable tbody td.col-details {
            display: none !important;
        }
    }

    /* Mobile: hide hash, date, description, actions; show details toggle and main */
    @media (max-width: 1199px) {
        .col-hash,
        .col-date,
        .col-desc,
        .col-action,
        table#holidayTable thead th.col-hash,
        table#holidayTable thead th.col-date,
        table#holidayTable thead th.col-desc,
        table#holidayTable thead th.col-action,
        table#holidayTable tbody td.col-hash,
        table#holidayTable tbody td.col-date,
        table#holidayTable tbody td.col-desc,
        table#holidayTable tbody td.col-action {
            display: none !important;
        }

        .col-details,
        .col-main,
        table#holidayTable thead th.col-details,
        table#holidayTable thead th.col-main,
        table#holidayTable tbody td.col-details,
        table#holidayTable tbody td.col-main {
            ...
            <div class="card-body">
                ...
                <div class="pagination-controls d-flex flex-column flex-md-row justify-content-between align-items-center mt-3">
                    <div class="d-flex align-items-center mb-3 mb-md-0">
                        ...
                        <select id="holidayPerPage" class="form-select form-select-sm"
            ...
            function loadHolidays() {
                $.ajax({
                    ...
                    const rows = holidays.map((holiday, index) => {
                        ...
                        const actions = `
                                <a class="me-3" href="/holidays/edit/${holiday.id}">
                                    <img src="{{ env('ImagePath') . 'admin/assets/img/icons/edit.svg' }}" alt="Edit">
                                </a>
                                <a class="me-3 confirm-text deleteHoliday" data-id="${holiday.id}" href="javascript:void(0);">
                        ...
                        <tr>
                            ...
                            <td class="col-main">
                                <div style="display: flex;">
                                    <span style="color: #1b2850; font-weight: 500;">${title}</span>
                                </div>
                                <div class="collapse mt-2 d-xl-none" id="details-${holiday.id}">
                                    <div>
                            ...
                            <td class="col-details">
                                <a href="#details-${holiday.id}" class="toggle-details" data-bs-toggle="collapse">
                    ...
                    $('#holidayTable tbody').html(rows || '<tr><td colspan="7" class="text-center">No records found</td></tr>');
                    updatePaginationUI();
                }).fail(handleError);
            }
